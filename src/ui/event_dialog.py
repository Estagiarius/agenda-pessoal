...
class EventDialog(QDialog):
    def __init__(self, event: Optional[Event] = None, parent=None):
        ...
        self.event = event # Armazena o evento original se estiver editando
        ...
        self.description_edit.setAcceptRichText(False) # Apenas texto plano
        self.description_edit.setFixedHeight(100) # Altura inicial para descrição
        ...
        # form_layout.addRow("Recorrência:", self.recurrence_rule_edit)
